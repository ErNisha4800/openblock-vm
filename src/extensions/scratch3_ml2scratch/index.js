...
const Message = {
  ...
  when_received_block: {
    ...
    'hi': 'लेबल प्राप्त होने पर: [लेबल]',
    'gu': 'જ્યારે લેબલ પ્રાપ્ત થાય છે:[LABEL]',
    'zh-cn': '接收到类别[LABEL]时',
    'zh-tw': '接收到類別[LABEL]時'
  },
  label_block: {
  ...
  counts_label: {
    ...
    'hi': 'लेबल की संख्या [LABEL]',
    'gu': 'લેબલની સંખ્યા [LABEL]',
    'zh-cn': '标签数量[LABEL]',
    'zh-tw': '標籤數量[LABEL]'
  },
  any: {
  ...
  download_learning_data: {
    ...
    'hi': 'लर्निंग डेटा डाउनलोड करें',
    'gu': 'શીખવાની માહિતી ડાઉનલોડ કરો',
    'zh-cn': '下载学习数据',
    'zh-tw': '下載學習資料'
  },
  upload_learning_data: {
    ...
    'hi': 'लर्निंग डेटा अपलोड करें',
    'gu': 'શીખવાની માહિતી અપલોડ કરો',
    'zh-cn': '上传学习数据',
    'zh-tw': '上傳學習資料'
  },
  upload: {
  ...
  upload_instruction: {
    ...
    'hi': 'एक फ़ाइल का चयन करें और अपलोड बटन पर क्लिक करें।',
    'gu': 'ફાઇલ પસંદ કરો અને અપલોડ બટન પર ક્લિક કરો.',
  ...
  confirm_reset: {
    ...
    'hi': 'क्या आप निश्चित रूप से रीसेट कर रहे हैं?',
    'gu': 'શું તમે રીસેટ કરવાની ખાતરી કરો છો?',
    'zh-cn': '你确定要重置吗？',
    'zh-tw': '您確定要重置嗎？'
  },
  toggle_classification: {
    ...
    'hi': 'बारी वर्गीकरण [CLASSIFICATION_STATE]',
    'gu': 'વળાંક વર્ગીકરણ [CLASSIFICATION_STATE]',
  ...
  set_classification_interval: {
    ...
    'hi': 'प्रत्येक [CLASSIFICATION_INTERVAL] सेकंड में एक बार लेबल करें',
    'gu': 'દર [CLASSIFICATION_INTERVAL] સેકન્ડમાં એકવાર લેબલ કરો',
  ...
  set_input: {
    ...
    'hi': '[INPUT] इमेज सीखें/वर्गीकृत करें',
    'gu': '[INPUT] છબી જાણો/વર્ગીકૃત કરો',
  ...
  first_training_warning: {
    ...
    'hi': 'पहले प्रशिक्षण में थोड़ा समय लगेगा, इसलिए बार-बार क्लिक न करें।',
    'gu': 'પ્રથમ તાલીમમાં થોડો સમય લાગશે, તેથી ફરીથી અને ફરીથી ક્લિક કરશો નહીં.',
    'zh-cn': '第一项研究需要一段时间，所以不要一次又一次地点击。',
    'zh-tw': '第一次訓練需要一段時間，請稍後，不要一直點擊。'
  }
}

const AvailableLocales = ['en', 'hi', 'gu', 'ja', 'ja-Hira', 'zh-cn', 'zh-tw'];
