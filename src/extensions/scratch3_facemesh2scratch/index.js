...
const Message = {
  getX: {
    ...
    'hi': 'व्यक्ति संख्या का x: [PERSON_NUMBER] , मुख्य बिंदु संख्या: [KEYPOINT]',
    'gu': 'વ્યક્તિ નંબરનો x: [PERSON_NUMBER] , મુખ્ય બિંદુ નંબર: [KEYPOINT]'
  },
  getY: {
    ...
    'hi': 'व्यक्ति संख्या का y: [PERSON_NUMBER] , मुख्य बिंदु संख्या: [KEYPOINT]',
    'gu': 'વ્યક્તિ નંબરનો y: [PERSON_NUMBER] , મુખ્ય બિંદુ નંબર: [KEYPOINT]'
  },
  peopleCount: {
    'ja': '人数',
    'ja-Hira': 'にんずう',
  ...
  setRatio: {
    ...
    'gu': 'ગુણોત્તરને [RATIO] પર સેટ કરો'
  },
  setInterval: {
    'ja': '認識を [INTERVAL] 秒ごとに行う',
    'ja-Hira': 'にんしきを [INTERVAL] びょうごとにおこなう',
    'en': 'Label once every [INTERVAL] seconds',
    'hi': 'प्रत्येक [अंतराल] सेकंड में एक बार लेबल करें',
    'gu': 'દર [INTERVAL] સેકન્ડમાં એકવાર લેબલ કરો'
  },
  on: {
    'ja': '入',
    'ja-Hira': 'いり',
  ...
  please_wait: {
    ...
    'hi': 'सेटअप में कुछ समय लगता है। ब्राउज़र रुक जाएगा, लेकिन कृपया प्रतीक्षा करें।',
    'gu': 'સેટઅપમાં થોડો સમય લાગે છે. બ્રાઉઝર અટકી જશે, પરંતુ કૃપા કરીને રાહ જુઓ.'
  }
}
const AvailableLocales = ['en', 'hi', 'gu', 'ja', 'ja-Hira'];
