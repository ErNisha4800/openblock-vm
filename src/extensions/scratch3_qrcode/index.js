...
const Locales = ['ja', 'ja-Hira', 'en', 'gu', 'hi'];
...
const Message = {
    ...
    qrStart : {
        ...
        'gu':'સ્કેન કરવાનું શરૂ કરો [INPUT]',
        'hi': 'स्कैन करना शुरू करें [INPUT]'
    },
    qrCameraInput : {
        'ja': 'カメラ',
        'ja-Hira': 'カメラ',
    ...
    qrStop : {
        ...
        'ja-Hira': 'よみとりをとめる',
        'en': 'stop scanning',
        'gu': 'સ્કેન કરવાનું બંધ કરો',
        'hi': 'स्कैन करना बंद करो'
    },
    qrScanning : {
        'ja': '読み取り中',
        'ja-Hira': 'よみとりちゅう',
    ...
    qrSetInterval : {
        ...
        'gu': 'સ્કેન અંતરાલ [INTERVAL] સેકન્ડ સેટ કરો',
        'hi': 'स्कैन अंतराल [अंतराल] सेकंड सेट करें'
    },
    qrData : {
        'ja': '読み取り結果',
        'ja-Hira': 'よみとりけっか',
    ...
    qrASCII : {
        ...
        'gu': 'અક્ષર [INDEX] ડેટાનો ASCII કોડ',
        'hi': 'अक्षर [INDEX] डेटा का ASCII कोड'
    },
    qrReset : {
        'ja': '読み取り結果を消す',
        'ja-Hira': 'よみとりけっかをけす',
    ...
    qrSetCameraTransparency : {
        ...
        'gu': 'કૅમેરાની પારદર્શિતાને [TRANSPARENCY] પર સેટ કરો',
        'hi': '[पारदर्शिता] के लिए कैमरा पारदर्शिता सेट करें'
    }
};
