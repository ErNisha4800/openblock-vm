...
const Message = {
  ...
  getX: {
    ...
    'hi': '[भाग] व्यक्ति संख्या का x। [PERSON_NUMBER]',
    'gu': '[ભાગ] વ્યક્તિ નંબરનો x. [PERSON_NUMBER]',
  ...
  getY: {
    ...
    'hi': '[भाग] वाई व्यक्ति नं। [PERSON_NUMBER]',
    'gu': '[ભાગ] વ્યક્તિ નં. [PERSON_NUMBER]',
...
const AvailableLocales = ['en', 'hi', 'gu', 'ja', 'ja-Hira', 'zh-tw'];
