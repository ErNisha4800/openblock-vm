...
const Message = {
    image_classification_model_url: {
        ...
        'hi': 'છબી વર્ગીકરણ મોડેલ URL [URL]',
        'gu': 'છબી વર્ગીકરણ મોડેલ URL [URL]',
    ...
    sound_classification_model_url: {
        ...
        'hi': 'ध्वनि वर्गीकरण मॉडल URL [URL]',
        'gu': 'ધ્વનિ વર્ગીકરણ મોડલ URL [URL]',
        'ko': '소리 분류 모델 URL [URL]',
        'zh-tw':'聲音分類模型網址[URL]'
    },
    ...
    classify_image: {
        ...
        'ja-Hira': 'がぞうをぶんるいする',
        'en': 'classify image',
        'hi': 'छवि वर्गीकृत करें',
        'gu': 'છબીનું વર્ગીકરણ કરો ',
        'ko': '이미지 분류하기',
        'zh-tw':'影像分類'
    },
    image_label: {
    ...
    when_received_block: {
        ...
        'hi': 'इमेज लेबल प्राप्त होने पर:[LABEL]',
        'gu': 'જ્યારે છબી લેબલ પ્રાપ્ત થાય છે:[LABEL]',
    ...
    image_label_confidence: {
        ...
        'hi': 'छवि का विश्वास [लेबल]',
        'gu': 'છબીનો વિશ્વાસ [LABEL]',
        'ko': '[LABEL] 이미지 신뢰도',
        'zh-tw':'影像置信度[LABEL]'
    },
    sound_label_confidence: {
        ...
        'hi': 'ध्वनि का विश्वास [लेबल]',
        'gu': 'અવાજનો વિશ્વાસ [LABEL]',
        'ko': '[LABEL] 소리 신뢰도',
        'zh-tw': '聲音置信度[LABEL]'
    },
    when_received_sound_label_block: {
        ...
        'hi': 'ध्वनि लेबल प्राप्त होने पर:[लेबल]',
        'gu': 'જ્યારે ધ્વનિ લેબલ પ્રાપ્ત થાય છે:[LABEL]',
    ...
    set_confidence_threshold: {
        ...
        'hi': 'विश्वास सीमा निर्धारित करें [CONFIDENCE_THRESHOLD]',
        'gu': 'વિશ્વાસ થ્રેશોલ્ડ સેટ કરો [CONFIDENCE_THRESHOLD]',
...
const AvailableLocales = ['en', 'hi', 'gu', 'ja', 'ja-Hira', 'ko', 'zh-cn', 'zh-tw'];
