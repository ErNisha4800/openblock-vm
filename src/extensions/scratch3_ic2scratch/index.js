...
const Message = {
  when_received_block: {
    ...
    'zh-cn': '收到分类结果时',
    'gu': 'જ્યારે વર્ગીકરણ ઉમેદવારો પ્રાપ્ત થાય છે',
    'hi':'जब वर्गीकरण उम्मीदवार प्राप्त हुए'
  ...
  toggle_classification: {
    ...
    'hi':'क्रम वर्गीकरण [CLASSIFICATION_STATE]'
  ...
  set_classification_interval: {
    ...
    'gu':'દર [CLASSIFICATION_INTERVAL] સેકન્ડમાં એકવાર વર્ગીકરણ કરો',
    'hi':'हर [CLASSIFICATION_INTERVAL] सेकंड में एक बार वर्गीकरण करें'
